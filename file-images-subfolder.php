...
$folderPath = getenv('FILE_IMAGE_SUBFOLDER') ?: 'Fileshare'; // local mounted folder path
...
<title>Fileshare Images - Mount</title>
...
<body>
<?php renderNavigation('file-images-subfolder.php'); ?>

<div class="container mt-4">
    <div class="page-header mb-3">
        <h1>File Share Images Mount</h1>
